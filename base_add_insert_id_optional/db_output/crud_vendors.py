...
from lingzhihua_db_models.models_all_table import Vendors   # 导入 Vendors 模型，注意文件位置
...
# 创建 vendors 数据
def create_vendors(db: Session, vendor_name:str,vendor_id: Optional[int] = None,):
