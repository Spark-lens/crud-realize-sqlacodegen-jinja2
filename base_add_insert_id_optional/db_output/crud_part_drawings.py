...
from lingzhihua_db_models.models_all_table import PartDrawings   # 导入 PartDrawings 模型，注意文件位置
...
# 创建 part_drawings 数据
def create_part_drawings(db: Session, file_extension:str, drawing_data:bytes,part_id: Optional[int] = None,):
