from db_output.crud_mock_data import get_mock_data_list, get_mock_data, create_mock_data, update_mock_data, delete_mock_data
...
try:
    with SessionLocal() as db:
        row = get_mock_data_list(db, 1, 2)        # 获取 mock_data 列表
